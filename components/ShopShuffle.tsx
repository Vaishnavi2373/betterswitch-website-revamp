  ...
  return (
    <>
      <style>{`
        ...
        .shop-floating {
          animation: shop-float 3s ease-in-out infinite;
        }
      ...
      <div className="relative h-24 flex items-center justify-center">
        ...
        <div className="shop-card-container shop-floating">
          <div className={`shop-card relative ${isFlipping ? 'flipping' : ''}`}>
            <div
              className="shop-card-face w-36 h-20 bg-white rounded-lg shadow-md flex items-center justify-center relative overflow-hidden border"
              style={{
                borderColor: `${shops[activeIndex].color}40`,
                boxShadow: `0 8px 20px -6px ${shops[activeIndex].color}30`
              }}
            >
              <div className="p-2">
                {shops[activeIndex].svg}
              </div>
            </div>
          </div>
        </div>
